...
const AppProvider = ({ children }) => {
  ...
  //Aggiorno lo state con la posizione in cui ho cliccato sulla ricetta , cosi quando arpo la nuova singlecocktailsScreen e dopo torno indietro sulla HomeScreen , ritorno esattamente all'altezza della ricetta
