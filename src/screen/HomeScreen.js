...
const HomeScreen = () => {
  ...
  useTitle("HOME");
  useEffect(() => {
    //Riporta l'utente alla posizione del cocktail cliccato (quindi va su singlecocktailscreen) una volta che torna in home
    if (scrollPosition) {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="input-search">
                <input
                  id="drink"
                  className="input"
                  placeholder={query} //per avere il valore cercato una volta che torno su questa pagina
                  value={input}
